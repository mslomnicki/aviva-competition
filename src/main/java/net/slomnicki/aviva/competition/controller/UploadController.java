...
public class UploadController {
    ...
    public String uploadFile(@RequestParam MultipartFile file,
        ...
        if (!file.getContentType().equals("text/xml")) {
            redirectAttributes.addFlashAttribute("flash", new FlashMessage("Błąd wysyłania pliki", "Błędny typ pliku"));
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("flash", new FlashMessage("Błąd wysyłania pliki", "Błąd przetwarzania (" + e.getMessage() + ")"));
            return "redirect:/upload";
        }
        return "redirect:/";
    }
